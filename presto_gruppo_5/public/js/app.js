...
document.addEventListener('DOMContentLoaded', function () {
  if ($("#drophere").length > 0) {
    ...
    var uniqueSecret = $('input[name="uniqueSecret"]').attr('value'); // console.log(csrfToken , uniqueSecret);
...
window.onload = function () {
  ...
  if (mustheadlogo.length > 0) {
    var logohome = document.querySelector(".musthead-logo");
  ...
  if (musthead.length > 0) {
    var cic = document.querySelector(".musthead");
...
window.onscroll = function () {
  ...
  if (whocard1.length > 0) {
    var cardwhy1 = document.querySelector(".card-why1");
  ...
  if (whocard2.length > 0) {
    var cardwhy2 = document.querySelector(".card-why2");
  ...
  if (whocard3.length > 0) {
    var cardwhy3 = document.querySelector(".card-why3");
